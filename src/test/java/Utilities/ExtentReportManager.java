...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		*/
		...
		sparkReporter.config().setDocumentTitle("EcommerceApp Automation Report"); // Title of report
		sparkReporter.config().setReportName("EcommerceApp Functional Testing"); // name of the report
		sparkReporter.config().setTheme(Theme.DARK);
		
		extent = new ExtentReports();
		extent.attachReporter(sparkReporter);
		extent.setSystemInfo("Application", "EcommerceApp");
